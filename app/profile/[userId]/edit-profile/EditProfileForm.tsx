...
export default function ItineraryForm({ travelType }: ItineraryFormProps) {
  ...
  return (
    <div className="card bg-main-2 w-full max-w-2xl shrink-0 shadow-2xl items-center">
      <form className="card-body" onSubmit={onSubmit}>
        <div className="form-control mt-6">
          <label className="label">
            <span className="label-text font-bold text-white">What is your Budget limit?</span>
          ...
          <div className="flex w-full">
            <div className="flex-grow place-items-center">
              <input name="min_budget" type="number" placeholder="Min Budget" className="input input-bordered text-white bg-main-3" required min={0} value={minBudget || ''} onChange={(e) => setMinBudget(Number(e.target.value))} />
            </div>
            <div className="divider divider-horizontal">-----</div>
            <div className="flex-grow place-items-center">
              <input name="max_budget" type="number" placeholder="Max Budget" className="input input-bordered text-white bg-main-3" required min={0} value={maxBudget || ''} onChange={(e) => setMaxBudget(Number(e.target.value))} />
            </div>
          </div>
        </div>
        ...
        <div className="form-control mt-6">
          <label className="label">
            <span className="label-text font-bold text-white">What do you like to see more?</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="size-6">
          ...
          <label className="label cursor-pointer">
            <span className="label-text text-white">More attractions</span>
            <input
              name="more_attractions"
              value="More Attractions"
              type="checkbox"
              className="checkbox accent-black border-white"
              checked={purpose.includes('More Attractions')}
              onChange={handleCheckboxChange}
            />
          </label>
          <label className="label cursor-pointer">
            <span className="label-text text-white">More scenery</span>
            <input
              name="more_scenery"
              value="More Scenery"
              type="checkbox"
          ...
          <label className="label cursor-pointer">
            <span className="label-text text-white">More restaurants</span>
            <input
        ...
        <div className="form-control mt-6">
          <label className="label">
            <span className="label-text font-bold text-white">Who are you traveling with?</span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="size-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            {travelType &&
              travelType.map((travel) => (
                ...
                >
                  <span className="label-text pr-4 text-white">
        ...
        <div className="form-control mt-6">
          <button className="btn border-none hover:text-white hover:bg-main-3 hover:bg-opacity-60 bg-main-3" type="submit" disabled={isLoading}>
