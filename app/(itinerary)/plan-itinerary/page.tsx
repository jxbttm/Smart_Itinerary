...
const ItineraryForm = dynamic(() => import('@/app/(itinerary)/plan-itinerary/ItineraryForm'));
    ...
    <div
      ...
      <div className="hero-overlay bg-opacity-60">
        <div className="flex flex-col items-center text-neutral-content mb-8 font-bold">
          ...
          <p className="mb-5">Embark on your dream adventure with just a few simple details. Smart Voyage will curate a personalized itinerary, crafted to match your unique preferences!</p>
        </div>
      </div>
      <div className="hero-content text-neutral-content text-center pt-16">
        <ItineraryForm countries={countryData} travelType={travelData}></ItineraryForm>
      </div>
    </div>
  )
}
